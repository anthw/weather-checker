...
const forecast = (latitude, longitude, callback) => {
  ...
  request({ url, json: true }, (error, { body }) => {
    ...
    // response error
      ...
      callback(undefined, `${daily.data[0].summary} It is currently ${temperature} degrees. There is a ${precipProbability}% chance of rain and a wind speed of ${daily.data[0].windSpeed} mph.`)
    }
  })
}
